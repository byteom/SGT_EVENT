...
/**
 * Student Password Reset Flow - Step 2: Reset Password
 */
export default function StudentResetPasswordPage() {
  ...
  useEffect(() => {
    ...
    if (!resetToken) {
      window.location.href = "/student/forgot-password";
    }
  }, []);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data?.success) {
        ...
        localStorage.removeItem("reset_reg_no");
    ...
    <div className="min-h-screen bg-soft-background flex items-center justify-center p-4">
      <div className="bg-card-background rounded-xl border border-light-gray-border shadow-soft max-w-md w-full p-8">
        ...
        <div className="mt-6 text-center">
          <Link href="/student/forgot-password" className="text-primary text-sm hover:underline">
